...
class Department(models.Model):
    ...
    director = models.OneToOneField('Participant', related_name='director_department', verbose_name='部门负责人', blank=True, null=True, on_delete=models.SET_NULL)
...
class Team(models.Model):
    ...
    director = models.OneToOneField(
        Participant,related_name='director_team',verbose_name='团队负责人',blank=True, null=True, on_delete=models.SET_NULL)
    
    # staff = models.ForeignKey(Participant, verbose_name='团队成员',related_name='staffs', null=True, on_delete=models.SET_NULL)
